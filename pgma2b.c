/* pgma2b.c: A module to convert ASCII pgm files to binary pgm files */
...
// Main function used to convert ASCII pgm files to binary pgm files
int main(int argc, char **argv) {
    ...
    pgmImage *pgma2b = NULL;
    pgma2b = (pgmImage *) malloc (sizeof(pgmImage));
    initializePgmStruct(pgma2b);
    ...
    int readError = pgmRead(inputFile, pgma2b, argv[1]);
    ...
    // Triggers if the magic number is 'P2'
    if (pgma2b->magicNumberArray[1] == '2') {
        // Changes the magic number to be 'P5'
        pgma2b->magicNumberArray[1] = '5';
        ...
        int writeError = pgmWrite(outputFile, pgma2b, argv[2]);
